...
export function SignOutIcon({ className = 'h-3.5 w-3.5' }: IconProps) {
  // Door-with-arrow shape (Lucide-style "log-out"): the box represents the
  // signed-in session, and the arrow points out of it.
  return (
    <svg viewBox="0 0 24 24" className={className} {...strokeProps()}>
